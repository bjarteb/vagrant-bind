...
Vagrant.configure("2") do |config|
  ...
  config.vm.define :ns1 do |node|
    node.vm.hostname = "ns1.example.com"
    node.vm.network "public_network", ip: "10.1.19.11", :bridge => "en0: Wi-Fi (AirPort)"
  ...
  config.vm.define :ns2 do |node|
    node.vm.hostname = "ns2.example.com"
    node.vm.network "public_network", ip: "10.1.19.12", :bridge => "en0: Wi-Fi (AirPort)"
    node.vm.provider "virtualbox" do |vb|
      vb.customize ["modifyvm", :id, "--memory", 512]
      vb.customize ["modifyvm", :id, "--natdnshostresolver1", "off"]
      vb.customize ["modifyvm", :id, "--natdnsproxy1", "off"]
